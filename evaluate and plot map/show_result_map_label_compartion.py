...
if __name__ == '__main__':
    ...
    for img_name in name:
        ...
        img = [img_path, true_mask, raw_mask]
        name = ['原始影像','真实标签', '初始标签']

        plot_maps(images=img, images_name=name, row_number=1, fontsize=34)
    
        plt.savefig(r'D:\硕士论文\gaofen_picture_0309\label_compartion\{}.png'.format(img_name[:-4]), bbox_inches='tight')
