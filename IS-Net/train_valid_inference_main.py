...
if __name__ == "__main__":
    ...
    if hypar["mode"] == "train":
        ...
        hypar["model_path"] = r"E:\segmentation_repo\DIS\saved_models\your_model_weights" ## model weights saving (or restoring) path
        ...
        hypar["valid_out_dir"] = r"E:\gaofen-competition\GaoFen_challenge_Te\test_result_DIS_2" ## output inferenced segmentation maps into this fold
        hypar["model_path"] = r"E:\gaofen-competition\GaoFen_challenge_TrVa\saved_weights_dis\your_model_weights" ## load trained weights from this path
        hypar["restore_model"] = "gpu_itr_48000_traLoss_0.235_traTarLoss_0.0064_valLoss_7.2324_valTarLoss_1.5435_maxF1_0.763_mae_0.06_time_0.020803.pth" ## "isnet.pth" ## name of the to-be-loaded weights
    ...
    hypar["cache_size"] = [492, 492] ## cached input spatial resolution, can be configured into different size
    ...
    hypar["input_size"] = [492, 492] ## mdoel input spatial size, usually use the same value hypar["cache_size"], which means we don't further resize the images
    hypar["crop_size"] = [492, 492] ## random crop size from the input, it is usually set as smaller than hypar["cache_size"], e.g., [920,920] for data augmentation
