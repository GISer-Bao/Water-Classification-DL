...
if __name__ == "__main__":
    ...
    dataset_tr = {"name": "DIS5K-TR",
                  "im_dir": r"E:\gaofen-competition\GaoFen_challenge_TrVa\train\Images",
                  "gt_dir": r"E:\gaofen-competition\GaoFen_challenge_TrVa\train\Masks",
                  "im_ext": ".jpg",
                  "gt_ext": ".png",
                  "cache_dir": r"E:\gaofen-competition\GaoFen_challenge_TrVa\train\Cache_TR"}
    
    dataset_vd = {"name": "DIS5K-VD",
                  "im_dir": r"E:\gaofen-competition\GaoFen_challenge_TrVa\validation\Images",
                  "gt_dir": r"E:\gaofen-competition\GaoFen_challenge_TrVa\validation\Masks",
                  "im_ext": ".jpg",
                  "gt_ext": ".png",
                  "cache_dir": r"E:\gaofen-competition\GaoFen_challenge_TrVa\validation\Cache_VD"}

    dataset_te1 = {"name": "DIS5K-TE1",
                  "im_dir": r"E:\gaofen-competition\GaoFen_challenge_Te\Images",
                  "gt_dir": r"E:\gaofen-competition\GaoFen_challenge_Te\Masks",
                  "im_ext": ".jpg",
                  "gt_ext": ".png",
                  "cache_dir": r"E:\gaofen-competition\GaoFen_challenge_Te\Cache_Te"}

    # dataset_tr = {"name": "DIS5K-TR",
    #               "im_dir": r"E:\GID\train_data_480\filter_contain_water\train\Images",
    #               "gt_dir": r"E:\GID\train_data_480\filter_contain_water\train\Masks",
    #               "im_ext": ".tif",
    #               "gt_ext": ".tif",
    #               "cache_dir": r"E:\GID\train_data_480\filter_contain_water\train\Cache_TR"}

    # dataset_vd = {"name": "DIS5K-VD",
    #               "im_dir": r"E:\GID\train_data_480\filter_contain_water\val\Images",
    #               "gt_dir": r"E:\GID\train_data_480\filter_contain_water\val\Masks",
    #               "im_ext": ".tif",
    #               "gt_ext": ".tif",
    #               "cache_dir": r"E:\GID\train_data_480\filter_contain_water\val\Cache_VD"}

    # dataset_te1 = {"name": "DIS5K-TE1",
    #               "im_dir": r"E:\GID\train_data_480\filter_contain_water\test\Images_RGB",
    #               "gt_dir": r"E:\GID\train_data_480\filter_contain_water\test\Masks",
    #               "im_ext": ".tif",
    #               "gt_ext": ".tif",
    #               "cache_dir": r"E:\GID\train_data_480\filter_contain_water\test\Cache_Te_RGB"}
    ...
    ## users can create mutiple dictionary for setting a list of datasets as vaidation sets or inference sets
    # and hypar["mode"] = "valid" for inference
    # valid_datasets = [dataset_vd] 
    valid_datasets = [dataset_te1]
    ...
    if hypar["mode"] == "train":
        ...
        hypar["model_path"] = r"E:\gaofen-competition\GaoFen_challenge_TrVa\save_weights_isnet" ## model weights saving (or restoring) path
        ...
        hypar["valid_out_dir"] = r"E:\GID\train_data_480\filter_contain_water\test\test_result_isnet" ## output inferenced segmentation maps into this fold
        hypar["model_path"] = r"E:\GID\train_data_480\filter_contain_water\train_val\save_weights_isnet_3" ## load trained weights from this path
        hypar["restore_model"] = "gpu_itr_50000_traLoss_0.7366_traTarLoss_0.032_valLoss_0.3725_valTarLoss_0.0542_maxF1_0.8675_mae_0.0234_time_0.02104.pth" ## "isnet.pth" ## name of the to-be-loaded weights
