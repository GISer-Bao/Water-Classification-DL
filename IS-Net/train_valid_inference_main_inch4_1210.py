    ...
    for k in range(len(valid_dataloaders)):
        ...
        for i_val, data_val in enumerate(valid_dataloader):
            ...
            for t in range(hypar["batch_size_valid"]):
                ...
                with torch.no_grad():
                    gt = torch.as_tensor(gt).to(device)
    ...
    for k in range(len(valid_dataloaders)):
        ...
        for i_val, data_val in enumerate(valid_dataloader):
            ...
            for t in range(hypar["batch_size_valid"]):
                ...
                ## recover the prediction spatial size to the orignal image size
                pred_val = torch.squeeze(F.upsample(torch.unsqueeze(pred_val,0),(shapes_val[t][0],shapes_val[t][1]),mode='bilinear',align_corners=True))
...
if __name__ == "__main__":
    ...
    dataset_tr = {"name": "DIS5K-TR",
                  "im_dir": r"E:\GID_experiment\allocate_data_492\train\image_NirRGB",
                  "gt_dir": r"E:\GID_experiment\allocate_data_492\train\raw_label",
                  "im_ext": ".tif",
                  "gt_ext": ".tif",
                  "cache_dir": r"E:\GID_experiment\allocate_data_492\train\Cache_TR_NirRGB"}

    dataset_vd = {"name": "DIS5K-VD",
                  "im_dir": r"E:\GID_experiment\allocate_data_492\test\image_NirRGB",
                  "gt_dir": r"E:\GID_experiment\allocate_data_492\test\raw_label",
                  "im_ext": ".tif",
                  "gt_ext": ".tif",
                  "cache_dir": r"E:\GID_experiment\allocate_data_492\test\Cache_VD_NirRGB"}
    ...
    #               "im_ext": ".tif",
    #               "gt_ext": ".tif",
    #               "cache_dir": r"E:\GID_experiment\allocate_data_492\test\Cache_Te_NirRGB"}
    ...
    dataset_te1 = {"name": "DIS5K-TE1",
                  ...
                  "im_ext": ".tif",
                  "gt_ext": ".tif",
                  "cache_dir": r"E:\GID_experiment\allocate_data_492\train\Cache_Te_NirRGB"}
    ...
    valid_datasets = [dataset_te1] # and hypar["mode"] = "valid" for inference
    ...
    if hypar["mode"] == "train":
        ...
        hypar["model_path"] = r"E:\GID_experiment\allocate_data_492\train\save_weights_isnet_1211" ## model weights saving (or restoring) path
        ...
        hypar["gt_encoder_model"] = "GTENCODER-gpu_itr_112000_traLoss_0.0249_traTarLoss_0.0022_valLoss_0.0617_valTarLoss_0.0021_maxF1_0.5875_mae_0.011_time_0.011528.pth"
    else: ## configure the segmentation output path and the to-be-used model weights path
        # hypar["valid_out_dir"] = r"E:\GID_experiment\allocate_data_492\test\sod_isnet_4_gt112000_isc52000_is" ## output inferenced segmentation maps into this fold
        # hypar["model_path"] = r"E:\GID_experiment\allocate_data_492\train\save_weights_isnet_1211" ## load trained weights from this path
        # hypar["restore_model"] = "gpu_itr_52000_traLoss_0.8152_traTarLoss_0.0674_valLoss_0.7255_valTarLoss_0.0591_maxF1_0.4941_mae_0.0511_time_0.020671.pth" ## "isnet.pth" ## name of the to-be-loaded weights

        hypar["valid_out_dir"] = r"E:\GID_experiment\allocate_data_492\train\sod_isnet_label_1212" ## output inferenced segmentation maps into this fold
        hypar["model_path"] = r"E:\GID\train_data_480\filter_contain_water\train_val\save_weights_isnet_4" ## load trained weights from this path
        hypar["restore_model"] = "gpu_itr_2000_traLoss_3.7448_traTarLoss_0.2047_valLoss_0.6889_valTarLoss_0.1567_maxF1_0.8165_mae_0.0706_time_0.023707.pth" ## "isnet.pth" ## name of the to-be-loaded weights

        # hypar["valid_out_dir"] = r"E:\GID_experiment\allocate_data_492\test\sod_isnet_4_80000_raw1212" ## output inferenced segmentation maps into this fold
        # hypar["model_path"] = r"E:\GID\train_data_480\filter_contain_water\train_val\save_weights_isnet_4" ## load trained weights from this path
        # hypar["restore_model"] = "gpu_itr_80000_traLoss_0.4549_traTarLoss_0.0177_valLoss_0.4784_valTarLoss_0.0719_maxF1_0.8682_mae_0.0188_time_0.022771.pth"
    ...
    hypar["max_epoch_num"] = 10000000 ## if early stop and max_ite couldn't stop the training process, stop it by the max_epoch_num
